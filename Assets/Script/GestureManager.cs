}, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x0000000000001FF7, 0x0000000000001FF7, 0x0000000000001C7F, 0x000000000000007F, 0x000000000000007F, 0x000000000000007F, 0x000000000000007F, 0x00000000000000FF, 0x00000000000000FF, 0x00000000000000FF, 0x0000000000000FF7, 0x0000000000000FF7, 0x0000000000000FFF, 0x00000000000003FF, 0x00000000000003FE, 0x00000000000003FC }, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x000000000000FF00, 0x000000000000FF87, 0x000000000000C79F, 0x000000000000C3FF, 0x000000000000C3FF, 0x00000000000003FB, 0x00000000000003E3, 0x00000000000007C7, 0x00000000000007C7, 0x0000000000000F9F, 0x0000000000000F7F, 0x0000000000007FFE, 0x0000000000007FFC, 0x0000000000007FE0, 0x0000000000003F80, 0x0000000000001E00 }, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x000000000000FFC0, 0x000000000000FFE7, 0x000000000000F9EF, 0x000000000000C1FF, 0x00000000000003FF, 0x00000000000003FF, 0x00000000000007FF, 0x00000000000007FF, 0x00000000000007FF, 0x0000000000000FFE, 0x0000000000000FFC, 0x0000000000001FF8, 0x0000000000003FF0, 0x0000000000003E00, 0x0000000000003C00, 0x0000000000003800 }, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x000000000000FFF0, 0x000000000000FFF7, 0x000000000000FE77, 0x000000000000C07F, 0x00000000000000FF, 0x00000000000007FF, 0x00000000000007FF, 0x00000000000007FF, 0x00000000000000F0, 0x00000000000001E0, 0x00000000000001E0, 0x00000000000001C0, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000 }, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x000000000000FF80, 0x000000000000FF80, 0x000000000000FB87, 0x000000000000C39F, 0x00000000000003FF, 0x00000000000007FF, 0x00000000000007FB, 0x00000000000007E7, 0x000000000000078F, 0x0000000000000F1F, 0x0000000000001F3E, 0x0000000000001E7C, 0x000000000000FEF8, 0x000000000000FFF0, 0x000000000000FFE0, 0x0000000000001FC0 }, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x0000000000003F80, 0x0000000000007FC0, 0x000000000000FBC0, 0x000000000000F3C3, 0x000000000000E383, 0x000000000000C387, 0x000000000000038F, 0x000000000000039F, 0x00000000000003BF, 0x00000000000003BF, 0x00000000000003FE, 0x00000000000003FC, 0x0000000000001FFC, 0x0000000000001FF8, 0x0000000000001FF8, 0x00000000000007F0 }, 16) ,"A"},
            {new ImageGestureImage(new ulong[] { 0x0000000000001FE3, 0x0000000000007FE7, 0x000000000000FCE7, 0x000000000000F8EF, 0x000000000000E0FF, 0x000000000000C0FF, 0x000000000000C0FF, 0x000000000000C0FF, 0x00000000000000FF, 0x00000000000000FE, 0x00000000000000FE, 0x00000000000000FC, 0x00000000000001F0, 0x00000000000001E0, 0x00000000000001C0, 0x0000000000000000 }, 16) ,"A"}
        };
        ...
        else
        {
            ...
            switch (recognizableImages[imageGesture.MatchedGestureImage])
            {
                ...
                case "\\":
                    ...
                    break;
                case "W":
                    if (RayCast.aimingObject && !container.gameObject.activeSelf && !RayCast.aimingObject.transform.parent.CompareTag("Animation"))
                    {
                    ...
                    break;
                case "A":
                    if (walkingPrefab!=null && MarkerlessObject!=null)
                    {
    ...
    private void LongPressGestureCallback(GestureRecognizer gesture, ICollection<GestureTouch> touches)
    {
        GestureTouch t = FirstTouch(touches);
            ...
            if (gesture.State == GestureRecognizerState.Began && MarkerlessObject && !RayCast.aimingObject.transform.parent.CompareTag("Animation"))
            {
                if (RayCast.aimingObject)
                {
                    temp = RayCast.aimingObject;
                }
            }
            else if (gesture.State == GestureRecognizerState.Executing && MarkerlessObject && !RayCast.aimingObject.transform.parent.CompareTag("Animation"))
            {
                tempPos = PlaceMarkerlessObject.GetCurrentPosition();
                tempPos.y = tempPos.y - 100;
                temp.transform.position = tempPos;
            }
            else if (gesture.State == GestureRecognizerState.Ended && MarkerlessObject && !RayCast.aimingObject.transform.parent.CompareTag("Animation"))
            {
                temp = null;
            }
    }
